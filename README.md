...
DrinkDash uses a centralized design system to keep the interface consistent.
...
Contains reusable font configurations for:
...
Centralizes corner-radius values used by buttons and UI components.
...
Centralizes animation configurations used throughout the application.

---

## 🎬 Animation

Animation is an important part of the DrinkDash experience.

The project uses SwiftUI's animation system for:
...
* Receipt content staging
* Navigation transitions

The receipt is progressively revealed using individual visibility states, creating a staged receipt-unrolling effect.
...
This keeps screen-level views focused on composition and behavior rather than repeating styling code.
